...
learning on Amazon SageMaker and Coach.

(For a similar Cart-pole example using Ray RLlib, see this
`link <../rl_cartpole_ray/rl_cartpole_ray_gymEnv.ipynb>`__. Another
